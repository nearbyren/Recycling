...
@AndroidEntryPoint class DeBugTypeFragment : BaseBindFragment<FragmentDebugTypeBinding>() {
    ...
    override fun initialize(savedInstanceState: Bundle?) {
        ...
        binding.actvClearPeel.setOnClickListener {
            cabinetVM.testWeightCali2(CmdCode.CALIBRATION_0)
        }
        //称重
...
//            setRbEnabled(false)
            ...
            cabinetVM.testWeightCali(CmdCode.CALIBRATION_1)
...
//                setRbEnabled(false)
            ...
            when (selected) {
                getString(R.string.kg_1) -> {
                    ...
                    weightKg = 1
                    cabinetVM.testWeightCali(CmdCode.CALIBRATION_2)
                }
                ...
                getString(R.string.kg_2) -> {
                    ...
                    weightKg = 2
                    cabinetVM.testWeightCali(CmdCode.CALIBRATION_3)
                }
                ...
                getString(R.string.kg_3) -> {
                    ...
                    weightKg = 3
                    cabinetVM.testWeightCali(CmdCode.CALIBRATION_4)
                }
                ...
                getString(R.string.kg_4) -> {
                    ...
                    weightKg = 4
                    cabinetVM.testWeightCali(CmdCode.CALIBRATION_5)
                }
