...
//                LogUtils.d(("getAsync onFailure e*******$e")
//                LogUtils.d(("getAsync onFailure e detailMessage*******" + e.message)
//                MainThreadManager {
...
//                )
//                LogUtils.d(("postAsyncString onFailure e detailMessage*******" + e.message)
//                MainThreadManager {
//                    onCommonSingleParamCallback.onError(
//                         ApplicationProvider.appContext.resources.getString(R.string.library_network_sneak_off)
//                    )
...
//                )
//                LogUtils.d(("postAsyncStream onFailure e detailMessage*******" + e.message)
//                MainThreadManager {
//                    onCommonSingleParamCallback.onError(
//                         ApplicationProvider.appContext.resources.getString(R.string.library_network_sneak_off)
//                    )
...
//        call.enqueue(object : Callback {
//            override fun onFailure(call: Call, e: IOException) {
//                LogUtils.d(("postAsyncForm onFailure e*******$e")
//                LogUtils.d(("postAsyncForm onFailure e detailMessage*******" + e.message)
//                MainThreadManager {
//                    onCommonSingleParamCallback.onError(
//                         ApplicationProvider.appContext.resources.getString(R.string.library_network_sneak_off)
//                    )
...
////                LogManager.LogUtils.d(("login onResponse dataEncrypt*****" + dataEncrypt)
//                val responseString = response.body?.string()
//                //                try {
...
//            }
//        } else {
//            LogUtils.d(("postAsyncFormAndFile fileList.size() = 0")
//        }
//
//        //构建请求体
//        val requestBody: RequestBody = multipartBodyBuilder.build()
...
//                            )
//                        )
//                        LogUtils.d(("fileMap.get(key).getName()*****" + fileMap[key]?.name
//                        )
//                    }
//                }
//            }
...
////        LogUtils.d(("bodyParams String*******" + bodyParams.toString())
////        Request request = new Request.Builder()
////                .get()
////                .url(url)
////                .build()
...
////                LogUtils.d(("getAppContentLength onFailure e*******" + e.toString())
////                LogUtils.d(("getAppContentLength onFailure e detailMessage*******" + e.getMessage())
...
////                    LogUtils.d(("getAppContentLength onResponse contentLength*******" + contentLength)
////                    MainThreadManager mainThreadManager = new MainThreadManager()
////                    mainThreadManager.setOnSubThreadToMainThreadCallback(new OnSubThreadToMainThreadCallback() {
////                        @Override
////                        public void onSuccess() {
...
////        LogUtils.d(("downloadApp bodyParams String*******" + bodyParams.toString())
...
////                        if ("alreadyDownloadLength".equals(key)) {
////                            alreadyDownloadLength = bodyParams.get(key)
////                            LogUtils.d(("downloadApp alreadyDownloadLength*****" + alreadyDownloadLength)
////                        } else if ("appContentLength".equals(key)) {
////                            appContentLength = bodyParams.get(key)
////                            LogUtils.d(("downloadApp appContentLength*****" + appContentLength)
...
////                            if (appInfo != null) {
////                                LogUtils.d(("versionUpdate appInfoList*****" + appInfo.toString())
////                                //如果存在数据，则更新这条数据
...
////                            }
////                            LogUtils.d(("downloadApp fileName*****" + fileName)
////                        } else if ("FILEPATH".equals(key)) {
////                            FILEPATH = bodyParams.get(key)
////                            LogUtils.d(("downloadApp FILEPATH*****" + FILEPATH)
////                        }
////                    }
////                }
...
////                    LogUtils.d(("downloadApp alreadyDownloadLengthL*****" + alreadyDownloadLengthL)
////                    LogUtils.d(("downloadApp appContentLengthL*****" + appContentLengthL)
////                    File dirs = new File(FILEPATH)
////                    if (!dirs.exists()) {
////                        LogUtils.d(("downloadApp*****!dirs.exists()")
////                        dirs.mkdirs()
////                    }
////                    File file = new File(dirs, fileName)
////                    if (!file.exists()) {
////                        file.createNewFile()
////                        LogUtils.d(("downloadApp*****!file.exists()")
////                    } else {
////                        LogUtils.d(("downloadApp file.getAbsolutePath()*****" + file.getAbsolutePath())
////                    }
////
...
////                                    })
////                                    mainThreadManager.subThreadToUIThread()
////                                    LogUtils.d(("alreadyDownloadLengthDownloading=" + alreadyDownloadLengthDownloading)
////                                } else {//没连网呢
...
////        }
////
////        LogUtils.d(("getDownloadApp alreadyDownloadLength*******" + alreadyDownloadLength)
////        LogUtils.d(("getDownloadApp appContentLength*******" + appContentLength)
...
//        //            LogUtils.d(("isNetworkAvailable*****" + info.toString())
